...
public class AutogeneratedSettingsVm : ViewModel
{
        ...
        ISchedulerProvider schedulerProvider)
    {
                ...
                return Observable.Create<(bool Processing, GetResponse<ReflectionSettingsBundleVm> SettingsVM)>(async (observer, cancel) =>
                {
                    try
                    {
                        ...
                        var reflectionBundle = await provideBundle.ExtractBundle(
                            ...
                            detectedLoadOrder: loadOrder.ObserveOn(schedulerProvider.MainThread),
                            linkCache: linkCache,
        ...
        _settingsLoading = targetSettingsVm
            ...
            .ToGuiProperty(this, nameof(SettingsLoading), scheduler: schedulerProvider.MainThread, deferSubscription: true);
        ...
        _bundle = targetSettingsVm
            ...
            .DisposePrevious()
            .ToGuiProperty<ReflectionSettingsBundleVm?>(this, nameof(Bundle), null, schedulerProvider.MainThread, deferSubscription: true);

        _status = targetSettingsVm
            .Select(x => (ErrorResponse)x.SettingsVM)
            .ToGuiProperty(this, nameof(Error), ErrorResponse.Success, schedulerProvider.MainThread, deferSubscription: true);
    }
}