...
public class SynthesisPipeline
{
    ...
    private GameRelease? _typicalOpenTargetRelease;
    private ModKey? _typicalOpenIdentifyingModKey;
    ...
    private async Task<int> OpenForSettings(OpenForSettings args, IFileSystem fileSystem)
    {
        ...
        args.GameRelease ??= _typicalOpenTargetRelease;
        args.ModKey ??= _typicalOpenIdentifyingModKey?.ToString();
    ...
    {
        _typicalOpenTargetRelease = targetRelease;
        _typicalOpenIdentifyingModKey = identifyingModKey;
