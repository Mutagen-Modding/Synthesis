...
namespace Mutagen.Bethesda.Synthesis
{
    ...
    public class SynthesisPipeline
    {
        ...
        private Type? _autogeneratedSettingsType;
        ...
        public SynthesisPipeline SetOpenForSettings(AsyncOpenForSettingsFunction action)
        {
            if (_openForSettings != null
                || _autogeneratedSettingsType != null)
            {
                throw new ArgumentException("Cannot add more than one callback for settings");
            }
            _openForSettings = action;
            return this;
        }

        public SynthesisPipeline SetAutogeneratedSettings<T>()
        {
            return SetAutogeneratedSettings(typeof(T));
        }

        public SynthesisPipeline SetAutogeneratedSettings(Type t)
        {
            if (_openForSettings != null
                || _autogeneratedSettingsType != null)
            {
        ...
        private async Task<int> QuerySettings(SettingsQuery args)
        {
            ...
            if (_autogeneratedSettingsType != null)
            {
                SettingsQueryResponse resp = new SettingsQueryResponse()
                {
                    SettingsClassType = _autogeneratedSettingsType.ToString()
                };
                System.Console.WriteLine(Parser.Default.FormatCommandLine(resp));
