...
namespace Mutagen.Bethesda.Synthesis
{
    ...
    public class SynthesisPipeline
    {
        ...
        private readonly List<ReflectionSettingsConfig> _autogeneratedSettingsTypes = new List<ReflectionSettingsConfig>();
        ...
        public SynthesisPipeline SetAutogeneratedSettings<T>(string nickname, string path)
        {
            return SetAutogeneratedSettings(typeof(T), nickname, path);
        }

        public SynthesisPipeline SetAutogeneratedSettings(Type t, string nickname, string path)
        {
            if (_openForSettings != null)
            {
                throw new ArgumentException("Cannot add more than one callback type for settings");
        ...
        private async Task<int> QuerySettings(SettingsQuery args)
        {
            ...
            {
                var configs = new ReflectionSettingsConfigs(_autogeneratedSettingsTypes.ToArray());
                System.Console.WriteLine(JsonConvert.SerializeObject(configs));
