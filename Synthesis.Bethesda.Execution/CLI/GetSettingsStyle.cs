            ...
            switch ((Codes)result.Result)
            {
                ...
                case Codes.AutogeneratedSettingsClass:
                    return new SettingsConfiguration(
                        ...
                        LinesToConfigs.Parse(result.Out).Configs);
                default:
