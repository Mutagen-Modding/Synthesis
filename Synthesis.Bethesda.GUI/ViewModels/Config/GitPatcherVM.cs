    ...
    public class GitPatcherVM : PatcherVM
    {
            ...
            : base(parent, settings)
        {
            ...
            PatcherSettings = new PatcherSettingsVM(
                ...
                needBuild: false,
                autoGenSettingsProvider: Inject.Scope.GetInstance<IProvideAutogeneratedSettings>(),
                repoCheckouts: Inject.Scope.GetInstance<IProvideRepositoryCheckouts>(),
                openForSettings: Inject.Scope.GetInstance<IOpenForSettings>(),
                getSettingsStyle: Inject.Scope.GetInstance<IGetSettingsStyle>(),
                openSettingsHost: Inject.Scope.GetInstance<IOpenSettingsHost>())
                .DisposeWith(this);
        ...
        public override PatcherRunVM ToRunner(PatchersRunVM parent)
        {
            ...
            return new PatcherRunVM(
                ...
                new SolutionPatcherRun(
                    ...
                    build: Inject.Scope.GetInstance<IBuild>(),
                    checkRunnability: Inject.Scope.GetInstance<ICheckRunnability>(),
                    repositoryCheckouts: Inject.Scope.GetInstance<IProvideRepositoryCheckouts>()));
        }
