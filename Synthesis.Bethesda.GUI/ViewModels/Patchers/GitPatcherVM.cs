...
namespace Synthesis.Bethesda.GUI
{
    public class GitPatcherVM : PatcherVM
    {
        ...
        public GitPatcherVM(
            ...
            IProvideAutogeneratedSettings autogeneratedSettings,
            ...
            : base(remove, selPatcher, confirmation, settings)
        {
            ...
            PatcherSettings = new PatcherSettingsVM(
                ...
                needBuild: false,
                autoGenSettingsProvider: autogeneratedSettings,
                repoCheckouts: repoCheckouts,
                openForSettings: openForSettings,
                getSettingsStyle: getSettingsStyle,
                windowPlacement: windowPlacement,
                openSettingsHost: openSettingsHost)
                .DisposeWith(this);
